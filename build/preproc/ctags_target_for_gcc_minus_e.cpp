# 1 "D:\\Project-371\\webserver\\webserver.ino"
# 2 "D:\\Project-371\\webserver\\webserver.ino" 2
# 3 "D:\\Project-371\\webserver\\webserver.ino" 2
# 4 "D:\\Project-371\\webserver\\webserver.ino" 2
# 5 "D:\\Project-371\\webserver\\webserver.ino" 2
# 6 "D:\\Project-371\\webserver\\webserver.ino" 2
# 7 "D:\\Project-371\\webserver\\webserver.ino" 2
...
<body>
    ...
    <h1 class="custom-heading">Lay1</h1>
    <form action="/Lay1" method="post">
...
void setupWiFi() {
    Serial.println();
    Serial.println("Connecting to " + String("CoEIoT") + " ...");

    WiFi.mode(WIFI_MODE_STA);
    WiFi.begin("CoEIoT", "iot.coe.psu.ac.th");
...
void setupWebServer() {
    ...
    webServer.on("/controlServo", HTTP_POST, []() {
        ...
        if (servoValue == "Lay1"&& !servoRunning) {
